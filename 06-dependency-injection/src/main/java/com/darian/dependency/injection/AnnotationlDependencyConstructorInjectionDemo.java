...
/***
 * 基于 Annotation 资源的依赖 Constructor 方法注入示例
 *
 * @author <a href="mailto:1934849492@qq.com">Darian</a> 
 * @date 2020/3/16  23:20
 */
public class AnnotationlDependencyConstructorInjectionDemo {
    public static void main(String[] args) {
        ...
        applicationContext.register(AnnotationlDependencyConstructorInjectionDemo.class);
